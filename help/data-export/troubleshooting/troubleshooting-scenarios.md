...
有关[!DNL Product Recommendations]中目录数据的其他疑难解答，请参阅Commerce知识库中的[产品推荐模块疑难解答](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/troubleshoot-product-recommendations-module-in-magento-commerce)。
...
1. 如果错误与配置或第三方扩展无关，请[提交支持票证](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#submit-ticket)以及相关日志条目。
