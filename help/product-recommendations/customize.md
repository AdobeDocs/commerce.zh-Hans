...
若要确保在页面上呈现推荐单元时自定义产品属性可用，请在Admin的[产品属性](https://experienceleague.adobe.com/zh-hans/docs/commerce-admin/catalog/product-attributes/create/attribute-product-create)页面中将`Used in Product Listing`属性设置为`Yes`。
