...
要在您的环境中重新激活目录数据，请[提交标题为“重新激活](https://experienceleague.adobe.com/zh-hans/docs/commerce-knowledge-base/kb/help-center-guide/magento-help-center-user-guide#experience-league-start-page)”的支持请求[!DNL Product Recommendations]并包含环境ID。 您环境中的目录数据应会在几小时内恢复。
