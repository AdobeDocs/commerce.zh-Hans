...
- 若要请求该功能，请[联系Adobe支持](https://experienceleague.adobe.com/zh-hans/docs/support-resources/adobe-support-tools-guide/adobe-commerce-support/adobe-commerce-help-center-user-guide){target="_blank"}，并引用该功能以将缺货产品移动到搜索结果的结尾。
