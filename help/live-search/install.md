...
> **HIPAA准备就绪**
>
>如果您正在将Adobe Commerce与HIPAA-Ready扩展和Healthcare加载项一起使用，请不要通过实时搜索处理任何受保护的健康信息(PHI)> 实时搜索不提供HIPAA服务。
>
...
[!DNL Live Search]可与PWA Studio配合使用，但店面开发人员可能看到与其他Commerce实施相比略有差异，尤其是在某些GraphQL驱动方案和整体响应特征中。
