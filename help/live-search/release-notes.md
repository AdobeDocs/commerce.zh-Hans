...
![修复](../assets/fix.svg) `ProductInterface`实时搜索[服务中的](https://developer.adobe.com/commerce/webapi/graphql/schema/live-search/queries/product-search/)对象已被弃用。 请改用目录服务中的`ProductView`对象。
