...
**智能排名**&#x200B;利用[Adobe AI](https://business.adobe.com/cn/ai.html)的店面行为数据分析，通过特定算法对选定类别中的所有产品进行排序。 选择智能排名后，产品的特定顺序会随着时间的推移而改变，因为[!DNL Adobe AI]会持续重新分析基础数据。 例如，随着购物者偏好变化，热门趋势产品会随着时间的推移自动变化。
智能排名方法有：
