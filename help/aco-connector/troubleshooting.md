...
# Adobe Commerce Optimizer连接器故障排除
...
- 确认OAuth客户端具有[!DNL Commerce Optimizer]引入服务所需的作用域（请参阅[获取IMS凭据](https://developer.adobe.com/commerce/services/optimizer/data-ingestion/authentication/#obtain-ims-credentials)）。

## 数据未同步

**检查项目级错误详细信息：**

1. 从Commerce管理员转到&#x200B;**[!UICONTROL System]** > **[!UICONTROL Data Transfer]** > **[!UICONTROL Data Feed Sync Status]**。
2. 选择失败的信息源以查看每个项目的错误详细信息。
...
如果问题仅影响特定目录源（商店视图代码）或价格手册，请检查相应的网站或商店视图是否已禁用同步。 请参阅[自定义数据导出配置](./get-started.md#customize-the-commerce-scopes-export-configuration)。
