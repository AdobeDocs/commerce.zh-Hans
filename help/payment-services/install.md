...
必须先从[Commerce Marketplace](https://experienceleague.adobe.com/en/docs/commerce-admin/start/resources/commerce-marketplace)下载该扩展，然后才能安装它。
...
在`php.ini`中增加环境上PHP的内存限制[](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/configure/app/php-settings#increase-php-memory-limit)。
