...
1. 启用并计划`sync_order_payment_status` cron作业，以便自动获取状态更新。 请参阅[配置cron作业](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cli/configure-cron-jobs)。
