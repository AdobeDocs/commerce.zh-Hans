...
在您[配置您的Commerce服务](connect.md#configure-commerce-services)并启用[沙盒测试](sandbox.md#sandbox-onboarding)或[实时付款](#enable-live-payments)之后，您必须将[!DNL Payment Services]设置为您的付款方式。
...
1. [清除您的缓存](https://experienceleague.adobe.com/en/docs/commerce-admin/systems/tools/cache-management)。
...
1. 在&#x200B;_选择国家/地区_&#x200B;模式中，选择您运营的国家/地区。
   ...
   付款服务目前为[5个国家/地区](compatibility.md#compatibility.md#standard-vs-advanced-payment-services-experience)的所有付款选项提供全面支持。 Payment Services为国家/地区列表中表示的所有其他国家/地区提供快速结账功能（付款选项的子集）。
...
此入门培训流程适用于[完全支持的国家/地区](compatibility.md#accepted-credit-cards-and-currencies)的商家。
...
此标准登录流程适用于仅提供[快速结帐支持](compatibility.md#accepted-credit-cards-and-currencies)的可用国家/地区的商家。
