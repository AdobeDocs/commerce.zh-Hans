...
以下发行说明介绍了[!DNL Payment Services]的最新版本。

Adobe支持最新发布的支付服务版本。 提供了旧版本的发行说明以供参考。
...
![新问题](../assets/new.svg)<!-- Issue PAY-6374 -->现在，[!DNL Payment Services]仪表板上的&#x200B;**设置**&#x200B;按钮将重定向到付款方法的管理员配置页面，从而为管理付款设置提供更加简化的工作流。

_2026年1月19日_

![新问题](../assets/new.svg)<!-- Issue PAY-6325 -->现在，商家可以在[交易报表](reporting.md#transactions-report-view)中将PayPal卖方ID作为列查看，以帮助识别特定客户进行的交易。
...
![新问题](../assets/new.svg)<!-- Issue PAY-5658 -->现在，商家可以按[交易报表](reporting.md#transactions-report-view)中的付款详细信息筛选交易，以获得更详细和准确的付款方式数据。

_2024年7月15日_

![新问题](../assets/new.svg)<!-- Issue PAY-5571 -->现在，商户可以在[交易报表](reporting.md#transactions-report-view)中按Commerce客户电子邮件筛选交易。 输入客户电子邮件以筛选该特定电子邮件的交易记录。

_2024年7月9日_

![新问题](../assets/new.svg)<!-- Issue PAY-5488 -->现在，商家可以在[交易报表](reporting.md#transactions-report-view)中将Commerce客户ID作为列查看，以帮助识别特定客户已进行的交易。 此外，商家还可以按此Commerce客户ID筛选关联订单的交易报表。
...
![新发行](../assets/fix.svg)<!-- Issue PAY-4888 -->现在，商家可以按[交易报表](reporting.md#transactions-report-view)中卡号的最后四位数筛选信用卡和借记卡交易。
...
![新](../assets/new.svg)<!-- Issue PAY-4288 -->现在，商家可以[仅配置&#x200B;_个_ PayPal付款按钮](payments-options.md#use-only-paypal-payment-buttons)，而&#x200B;_不能_&#x200B;使用PayPal信用卡付款选项。 这允许商家提供各种支付选项，包括Venmo和PayPal支付按钮，并使用现有的信用卡提供商而不是PayPal信用卡支付选项。

![New](../assets/new.svg)<!-- Issue PAY-4050 -->为订单付款状态报告添加了[数据可视化视图](payouts.md#payouts-data-visualization-view)，该视图显示在付款服务主页上。
...
![新](../assets/new.svg)<!-- Issue PAY-3705 --> `increment_id`现在可用于协调外部ERP系统中的付款。 它传播到`custom_id` _和_ `invoice_id`，在PayPal webhook和付款的商家活动详细信息中均可见。
...
![新](../assets/new.svg)<!-- Issue PAY-3420 --> Apple Pay现已作为PayPal智能按钮提供。 此[付款选项](payments-options.md#apple-pay-button)允许客户在其iOS或macOS设备上使用Touch ID功能选择Apple Pay。 Apple Pay使用存储在设备上的信用卡和借记卡支付凭据处理支付。

_2021年6月28日_

![新的](../assets/new.svg)<!-- Issue PAY-1720 -->商店订单争议现已在[订单付款状态报表](order-payment-status.md#view-disputes)中可用。 您可以直接从[!DNL Payment Services]导航到PayPal解决中心来解决争议。

![来自[!DNL Payment Services]主页的](../assets/new.svg)<!-- Issue PAY-2854 -->新用户体验改进包括能够在当前继承级别修改配置，以及改进了标题和导航的显示。

![新](../assets/new.svg)<!-- Issue PAY-2854 -->现在，当您从沙盒模式切换到生产模式，并尝试离开包含尚未保存的更新的视图时，您会看到警告。

![新](../assets/new.svg)<!-- Issue PAY-2761 -->您现在可以通过使用“列”设置控件显示或隐藏列，自定义在[订单付款状态报表](order-payment-status.md#show-and-hide-columns)和[付款报表](payouts.md#show-and-hide-columns)中显示的数据。
...
![修复了问题](../assets/fix.svg)<!-- PAY-6769 -->修复了使用PayPal智能按钮的EDS店面中导致某些付款方法在结账页面上不可用的间歇性问题。

## v2.16.0

_2026年7月27日_

![新问题](../assets/new.svg)<!-- Issue PAY-6510 -->商家现在可以直接从[!DNL Commerce Admin]自助服务网站范围内的其他PayPal帐户入门。[!DNL Payment Services] 主页现在包含一个&#x200B;**[!UICONTROL Connect a different PayPal account for a website]**&#x200B;按钮，该按钮重定向到付款方法的管理员配置页面。 有关详细信息，请参阅[为网站连接其他PayPal帐户](connect-website-account.md)。
...
![新](../assets/new.svg)<!-- PAY-6400 -->添加了&#x200B;**[!UICONTROL Line Items Enabled]**&#x200B;配置以启用或禁用向PayPal发送行项目和金额细分。 此设置有助于解决当第三方扩展添加[!DNL Payment Services]不支持的自定义费用时的签出问题。 有关详细信息，请参阅[行项](line-items.md)。

![新](../assets/new.svg)<!-- PAY-6457 -->在结帐开始时添加了[快速付款按钮](payments-options.md#express-checkout-buttons)以鼓励更快地结帐。

![新](../assets/new.svg)<!-- PAY-6458 -->已添加对特定于区域和本地付款选项的[本地付款方法(LPM)](payments-options.md#local-payment-methods)的支持。 商家可以直接在[Commerce](configure-admin.md#local-payment-methods)中启用或禁用可用的LPM。

![新](../assets/new.svg)<!-- PAY-6377 -->添加了[购买者的国家/地区](sandbox.md#buyers-country)沙盒配置以模拟购买者的位置并控制呈现的付款方法。

![已修复问题](../assets/fix.svg)<!-- PAY-6458 -->通过传递买家电子邮件地址数据，增强了防欺诈功能，改进了与PayPal欺诈过滤器的兼容性。

![修复了问题](../assets/fix.svg)<!-- PAY-6413 -->修复了由于缺少送货地址而无法对虚拟产品完成PayPal签出操作的问题。

![修复了问题](../assets/fix.svg)<!-- PAY-6450 -->修复了在产品详细信息页面、迷你图、购物车和结帐顶部未正确处理PayPal按钮结帐错误的问题。

![修复了问题](../assets/fix.svg)<!-- PAY-6453 -->在GraphQL签出时禁用了服务器端送达回调流程以防止签出时发生冲突。

![已修复问题](../assets/fix.svg)<!-- PAY-6456 -->已更新[Apple Pay](configure-admin.md#apple-pay)配置描述以阐明Apple拒绝来自未验证域的付款。 商家必须验证使用Apple Pay按钮的任何域。 国家限制适用。

## v2.13.3

_2026年1月14日_

![修复了问题](../assets/fix.svg)<!-- PAY-6399 -->修复了在管理员签出期间使用错误保险存储卡的问题。 现在，下订单时可正确使用选定的卡。

## v2.13.2

_2026年1月5日_

![修复了问题](../assets/fix.svg)<!-- PAY-6390 -->通过实施改进的JS缩小功能进行了常规改进和优化。

## v2.13.1

_2025年12月18日_

![修复了问题](../assets/fix.svg)<!-- PAY-6355 -->修复了商家在结账期间无法选择配送方式的问题。

![修复了问题](../assets/fix.svg)<!-- PAY-6347 -->通过删除不必要的API调用改进了签出弹性。

![修复了问题](../assets/fix.svg)<!-- PAY-6368 -->实施了回退机制，以便在主域不可用时加载Payments SDK，从而确保在结账期间信用卡字段仍可访问。
...
![新](../assets/new.svg)<!-- PAY-xxxx -->现在，[!DNL Payment Services]支持PayPal的&#x200B;**一次性结帐(OTC)**&#x200B;模式，其中包含内置联系人和投放信息。

![新](../assets/new.svg)<!-- PAY-xxxx -->通过&#x200B;**PayPal应用切换身份验证**&#x200B;增强的移动体验，以及更流畅的用户历程的改进API集成。 此功能仅适用于基于美国[!DNL Payment Services]的客户。

![新](../assets/new.svg)<!-- PAY-xxxx -->已为Fastlane添加&#x200B;**3D安全(3DS)身份验证**&#x200B;支持，以满足&#x200B;**强客户身份验证(SCA)**&#x200B;要求。 这使英国和EU [!DNL Payment Services]商户能够使用&#x200B;**3DS身份验证**&#x200B;处理交易，从而增强欺诈防范并确保遵守区域法规。

![新](../assets/new.svg)<!-- PAY-xxxx -->现在，[!DNL Payment Services]商家可以为Fastlane签出组件选择&#x200B;**浅色和深色主题**，从而允许签出页面与其网站设计相匹配。 如果自定义样式不符合辅助功能标准，则系统会自动恢复默认设置。

![修复了问题](../assets/fix.svg)<!-- PAY-xxxx -->修复了使用3DS质询&#x200B;**管理员签出期间的加载程序问题**。

![修复了问题](../assets/fix.svg)<!-- PAY-xxxx -->改进了通过API存储付款配置&#x200B;**时的**&#x200B;验证。
...
![已修复问题](../assets/fix.svg)<!-- PAY-6164 -->现在，[!DNL Payment Services]在[PayPal服务器端送货回拨(SSSC)](https://developer.paypal.com/docs/multiparty/checkout/standard/customize/shipping-module/)中使用了可用送货方法的基本货币。
...
![新](../assets/new.svg)<!-- PAY-5938 -->现在，[!DNL Payment Services]允许商家管理付款设置，以最大程度地提高业务的灵活性。 此版本改进了为商家支持的地区和品牌附加[多个PayPal帐户](configure-admin.md#use-multiple-paypal-accounts)的功能。 我们的销售团队可以提供入门链接，以设置您的网站和商店视图范围。
...
![新建](../assets/fix.svg)<!-- PAY-5789 --> [!DNL Payment Services]现在支持[使用Google Pay的3D安全身份验证](security.md#3ds)，增强了商家和客户在付款交易过程中的安全性。

![修复](../assets/fix.svg)<!-- PAY-5703 --> [!DNL Payment Services]添加了[客户直接在其&#x200B;**我的帐户**](vaulting.md#vaulting-without-purchase)&#x200B;中保存卡片的功能，从而改善了便利性并简化了未来的结账流程。`Vault without purchase functionality might not be 100% compatible with Adobe Commerce 2.4.4 due to a known issue with` [`GraphQL authorization mechanisms`](https://developer.adobe.com/commerce/webapi/graphql/usage/authorization-tokens/)。
...
![修复](../assets/fix.svg)<!-- PAY-5492 -->修复了商家将自定义条款和条件添加到结账页面时出现的问题。 在[快速结帐](payments-options.md#standard-vs-advanced-payments-experience)期间，购物者现在可以接受这些条款和条件来完成结帐，而不会出现任何问题。
...
![新](../assets/new.svg)<!-- PAY-4877 -->现在，[!DNL Payment Services]支持[L2/L3定价功能](levels-card-payment-transactions.md#level-2-and-level-3)。 此功能仅适用于已启用IC++定价的[!DNL Payment Services]客户。 如果要使用L2/L3处理[!DNL Payment Services]的数据，请与您的[!DNL Payment Services]帐户管理员联系。
...
对于Adobe Commerce版本2.4.7及更高版本，![修复](../assets/fix.svg)<!-- Issue PAY-5396 -->[!DNL Payment Services]现在支持`--db-prefix`参数[&#128279;](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/advanced#install-from-the-command-line)的Adobe Commerce准则。
...
![新](../assets/new.svg)<!-- PAY-4868 -->商家可以通过管理员成功[在整个购买体验](payments-options.md)中配置Google Pay，类似于[!DNL Payment Services]中的其他付款按钮。

![新建](../assets/new.svg)<!-- PAY-4381 --> [Payment Services支持通过GraphQL进行Google Pay](https://developer.adobe.com/commerce/webapi/graphql/payment-services-extension/)，从而允许商家在使用Google Pay付款方式时体验Headless Commerce。

![新](../assets/new.svg)<!-- PAY-4878 -->现在，已为Adobe Commerce和Magento Open Source商家捆绑了[!DNL Payment Services]基本签出功能。[!DNL Payment Services] 现在可以支持全球200个地理区域内有业务的商家。[!DNL Payment Services] 基本结账功能在自助式入门培训中提供借记/贷记、PayPal、Venmo（如果可用）和PayLater（如果可用）选项。

![修复](../assets/fix.svg)<!-- PAY-5291 -->某些交易记录的接收付款确认可能延迟。 在这种情况下，商家现在可以获得订单的更新付款状态。 [付款服务通过检测待定交易并主动监视这些交易并在捕获待定状态时进行更新，来检测订单中付款交易](order-payment-status.md#payment-status-updates)的待定状态。
...
- 店面的客户订单页面
- 发送给购物者的订单确认电子邮件
- 从Commerce管理员的[订单详细信息视图](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/order-management/orders/order-processing#view-an-order)中。
...
![新建](../assets/new.svg)<!-- PAY-4381 --> [Payment Services现在支持GraphQL集成](https://developer.adobe.com/commerce/webapi/graphql/payment-services-extension/)。 由于GraphQL支持PayPal支付按钮、托管字段和Apple Pay，因此[!DNL Payment Services]现在支持Headless Commerce设置。
...
![New](../assets/new.svg)<!-- PAY-4638 -->添加了[与Signifyd](fraud-protection.md)的集成，后者提供自动防欺诈服务。

![新建](../assets/new.svg)<!-- PAY-3981 --> [已将Apple Pay提升为单独的付款选项](payments-options.md#apple-pay-button)，位于PayPal付款按钮之外，以提高购物者对付款选项的可见性，并允许商家控制Apple Pay的放置和样式。

![新](../assets/new.svg)<!-- PAY-4002 -->改进了信用卡字段结账的用户体验，包括样式改进，如添加付款图标，以降低购物者的认知负荷并提高转化率。

![新](../assets/new.svg)<!-- PAY-4002 -->添加的功能允许商家[对其付款选项排序](configure-admin.md#paypal-payment-buttons)以优先处理某些付款选项。 此功能可提高结帐对话率。

![新](../assets/new.svg)<!-- PAY-4035 -->商家现在可以使用[!DNL Payment Services]管理主页上的新[交易报告](reporting.md#transactions-report-view)有效地监控其商店的运行状况并识别任何交易问题。 此报表还会提供有关交易授权率和负交易趋势的数据。
...
![新](../assets/new.svg)<!-- Issue xxx -->在下列国家/地区和相关货币中添加了[可用性](compatibility.md#standard-vs-advanced-payment-services-experience)：澳大利亚、法国、英国。

![新](../assets/new.svg)<!-- Issue PAY-4296 -->添加了[针对管理员角色的扩展资源](configure-admin.md#configure-roles)，以确保管理员用户可以创建和管理客户的订单，并可以在“销售”菜单中看到[!DNL Payment Services]。

![新](../assets/new.svg)<!-- Issue PAY-4236 -->已添加[在结账过程中发生错误的订单的自动失效](checkout.md#order-auto-voided-if-error)。

![新建](../assets/new.svg)<!-- Issue PAY-4183 -->创建了[在结帐页上显示信用卡/借记卡付款选项按钮](payments-options.md#paypal-debit-or-credit-card-button)的功能。
...
![修复](../assets/fix.svg)<!-- Issue PAY-4226 -->修复了阻止新[!DNL Payment Services]商家在Admin中使用签出功能的问题。[!DNL Payment Services] 之前使用的是Commerce客户ID，而新客户不存在该ID。
...
![新](../assets/new.svg)<!-- Issue PAY-3950 -->商家现在可以为其商店启用[即时购买Commerce功能](https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/point-of-purchase/checkout-instant-purchase)，以便购物者可以（使用[保险存储信用卡信息](vaulting.md)）加快结帐速度。
...
![新](../assets/new.svg)<!-- Issue PAY-784 -->[!DNL Payment Services]现在包括设置商家帐户以[使用多个PayPal商业帐户](configure-admin.md#use-multiple-paypal-accounts)的功能。 这使商家能够使用不同的货币在多个国家/地区经营您的商店，或者将Adobe Commerce用于您的部分业务。

![新](../assets/new.svg)<!-- Issue PAY-3231 -->商家可以[将[!UICONTROL Soft Descriptor]](configure-admin.md)添加到客户交易银行对帐单上显示的网站或单个商店视图配置，以描述品牌、商店或产品线。

![新建](../assets/new.svg)<!-- Issue PAY-3707 --> [启用或禁用信用卡字段和PayPal付款按钮](configure-admin.md#paypal-payment-buttons)，以便在[!DNL Payment Services]设置中签出。
...
![已知问题](../assets/bug.svg)<!-- Issue PAY-0 --> [!DNL Payment Services]与`commerce-data-export` v101.20及更高版本不兼容，这会使其与[[!DNL Channel manager] 扩展](https://experienceleague.adobe.com/en/docs/discontinued/using/commerce-channels)（已停用）不兼容。
...
![新建](../assets/new.svg)<!-- Issue PAY-2681 --> 对于信用卡和PayPal交易，[!DNL Payment Services]支持[加元(CAD)](compatibility.md#standard-vs-advanced-payment-services-experience)。
...
![已修复问题](../assets/fix.svg)<!-- Issue PAY-2277 -->您现在可以选择[启用或禁用单个PayPal付款按钮](configure-admin.md#paypal-payment-buttons)。

![已修复问题](../assets/fix.svg)<!-- Issue PAY-2561 -->以前删除的产品未出现在&#x200B;_审阅订单_&#x200B;页面的购物车中。

![已知问题](../assets/bug.svg)<!-- Issue PAY-2842 -->在沙盒环境中处理付款时，使用PayPal[&#128279;](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26825)测试信用卡交易记录可能失败。
...
![新](../assets/new.svg)<!-- Issue PAY-124 --> [!DNL Adobe Commerce]和[!DNL Magento Open Source]的[!DNL Payment Services]扩展可以为[[!DNL Adobe Commerce] 在云基础架构](install.md#adobe-commerce-on-cloud-infrastructure)上或[内部部署](install.md#on-premises-and-other-configurations)实例安装。 这些方法需要使用命令行接口。
...
![已知问题](../assets/bug.svg)<!-- Issue PAY-2473 -->在安装扩展期间使用[不正确的编辑器键](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26826)会阻止用户使用正确的`MAGEID`进行[身份验证](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/prerequisites/authentication-keys)。

![已知问题](../assets/bug.svg)<!-- Issue PAY-2474 --> [!DNL Payment Services]报告[不能立即同步](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26837)。

![已知问题](../assets/bug.svg)<!-- Issue PAY-2475 -->如果您在新用户引导期间创建了[!DNL Payment Services]的[PayPal沙盒帐户](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-26836)，则无法验证该帐户。
