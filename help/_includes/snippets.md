...
>[!NOTE]
>
>[!DNL Commerce Storefront on Edge Delivery Services]的[放置组件](https://experienceleague.adobe.com/en/tools/commerce-storefront/dropins/all/introduction/)自动获取最新的GraphQL更改（新字段、限制和查询行为）。
...
| 服务 | 店面 |
| --- | --- |
| [AEM Assets集成](../aem-assets-integration/release-notes.md)<br>[Commerce Optimizer连接器](../aco-connector/release-notes.md) | [店面版本信息](https://experienceleague.adobe.com/en/tools/commerce-storefront/releases/)<br>[店面变更日志](https://experienceleague.adobe.com/en/tools/commerce-storefront/releases/changelog/) |
