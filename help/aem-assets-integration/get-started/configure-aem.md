...
* 为您的Commerce实例配置的&#x200B;**IMS组织ID**。

* 要在AEM as a Cloud Service上启用具有OpenAPI功能的[Dynamic Media](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dynamic-media-open-apis/dynamic-media-open-apis-overview#enable-dynamic-media-open-apis)，请提交Adobe支持工单，并提供以下信息：
