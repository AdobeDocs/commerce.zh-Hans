...
* [店面B2B功能](https://experienceleague.adobe.com/developer/commerce/storefront/setup/configuration/storefront-compatibility/b2b/#major-features) — 了解Storefront兼容性包中提供的B2B功能，该包自动为所有[!DNL Adobe Commerce as a Cloud Service]实例安装。
