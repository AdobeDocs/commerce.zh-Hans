...
查看[AEM Assets集成](../aem-assets-integration/overview.md)指南，详细了解如何将AEM Assets支持的产品可视化与[!DNL Adobe Commerce as a Cloud Service]集成。
...
<table>
  <tr>
    <td align="left">
      <strong>由AEM Assets提供支持的产品视觉效果</strong>
      <ul>
