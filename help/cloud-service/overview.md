...
[!DNL Adobe Commerce as a Cloud Service]通过使企业能够在加速创新的同时提供并快速扩展数字运营而提供了灵活性、可扩展性和效率。 Adobe的云原生基础架构可自动调整资源，以满足流量、订单和目录管理的峰值需求。
...
<table style="table-layout:auto">
  <tr>
    <td align="left">
      <img src="../assets/icon-checkmark-circle-outline.svg" alt="复选标记" align="center"> <strong>Commerce店面</strong>
    </td>
    <td align="left">
  ...
  <tr>
    <td align="left">
      <img src="../assets/icon-checkmark-circle-outline.svg" alt="复选标记" align="center"> <strong>促销服务</strong>
    </td>
    <td align="left">
      管理产品目录、定价和库存的后端服务
    </td>
  ...
  <tr>
    <td align="left">
      <img src="../assets/icon-checkmark-circle-outline.svg" alt="复选标记" align="center"> <strong>产品视觉效果</strong>
    </td>
    <td align="left">
      产品图像和媒体的数字资产管理
    </td>
  ...
  <tr>
    <td align="left">
      <img src="../assets/icon-checkmark-circle-outline.svg" alt="复选标记" align="center"> <strong>开发人员平台</strong>
    </td>
    <td align="left">
...
>[!VIDEO](https://video.tv.adobe.com/v/3443277?captions=chi_hans&learn=on)
...
要使用[!DNL Storefront Builder]的基于文档的简单创作或可视化编辑功能在几分钟内创建丰富体验，请使用由[!DNL Edge Delivery Services]提供支持的Adobe的[[!DNL Commerce Storefront]](https://experienceleague.adobe.com/en/tools/commerce-storefront/)。
...
>[!NOTE]
>
>[!DNL Adobe Commerce as a Cloud Service]不支持Luma店面。 如果您是从[!DNL Adobe Commerce on Cloud]或内部部署迁移，请参阅[现有店面](https://experienceleague.adobe.com/en/tools/commerce-storefront/discovery/#existing-storefronts)以了解过渡指南。
...
查看[AEM Assets集成](../aem-assets-integration/overview.md)指南，详细了解如何将[!DNL Product Visuals powered by AEM Assets]与[!DNL Adobe Commerce as a Cloud Service]集成。

### [!DNL Product Visuals]或[!DNL AEM Assets]

以下比较可帮助您选择supply chain所需内容的最佳选项：
...
<table>
  <tr>
    ...
    <td align="center" colspan="3">
      <strong>Adobe品牌集成可用于在产品之间轻松迁移。</strong>
    </td>
  </tr>
</table>
...
Adobe为开发人员提供了全面的扩展点和工具，用于构建可扩展Commerce Foundation功能并与第三方系统（如CRM、ERP和PIM）集成的应用程序。 这些工具可通过以下方式降低平台的总拥有成本：
...
[!DNL Commerce Foundation]提供安全的自动托管平台和自助服务功能，用于在云原生环境中管理Commerce应用程序。
...
开发人员可以使用全面的[GraphQL](https://developer.adobe.com/commerce/webapi/graphql/)和[REST API](https://developer.adobe.com/commerce/webapi/rest/)将[!DNL Commerce Foundation]与第三方系统集成并扩展Commerce功能。
