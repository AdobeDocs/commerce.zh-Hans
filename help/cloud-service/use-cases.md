---
title: 用例
description: 了解如何使用Adobe Commerce as a Cloud Service完成实际用例和支持业务场景。
role: User, Leader
...
以下用例演示了Adobe Commerce as a Cloud Service支持的核心功能和业务场景，使您能够加快开发并启动高影响力的体验。
...
1. 在Commerce管理员中，导航到&#x200B;[!UICONTROL **设置**] > [!UICONTROL **付款方式**]。
