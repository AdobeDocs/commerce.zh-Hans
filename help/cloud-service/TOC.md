...
- [以客户身份登录](https://experienceleague.adobe.com/zh-hans/docs/commerce-admin/customers/customer-accounts/manage/login-as-customer){target="_blank"}
...
- 教程 {#tutorials}
   ...
   - [投放评估扩展教程](tutorials/delivery-estimates-extension.md)
   - [库存通知扩展教程](tutorials/in-stock-notification-extension.md)
   - [产品审核扩展教程](tutorials/product-reviews-extension.md)
- 架构 {#schemas}
