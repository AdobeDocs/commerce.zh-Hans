...
>[!NOTE]
>
>有关[!DNL Adobe Commerce as a Cloud Service] (SaaS)中可用功能以及这些功能如何与其他版本的Adobe Commerce(如[!DNL Adobe Commerce on Cloud]和[!DNL Adobe Commerce on Premises] (PaaS))对齐的更多信息，请参阅[功能比较](../cloud-service/feature-comparison.md)。
