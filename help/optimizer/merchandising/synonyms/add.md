...
通过添加您自己策划的[!DNL Adobe Commerce Optimizer]同义词列表来提高客户参与度。 每个目录源最多可以添加200个同义词。
...
1. 从左边栏转到&#x200B;_促销_ > **同义词**。
1. 单击&#x200B;**[!UICONTROL Create synonyms]**&#x200B;按钮。
...
在此示例中，要匹配的关键字是“pants”，而扩展术语集是“trousers， slacks”。
   ...
   ![双向同义词](../../assets/synonym-add-two-way.png)
...
1. 输入&#x200B;**关键字**&#x200B;和&#x200B;**扩展**&#x200B;术语。 用逗号分隔多个术语。
   ...
   ![单向同义词](../../assets/synonym-add-one-way.png)
