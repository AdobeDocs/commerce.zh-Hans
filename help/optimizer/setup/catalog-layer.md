...
当您启用[产品可视化图表](product-visuals.md)时，AEM Assets集成会自动创建和管理专门用于AEM Assets内容的目录层。 默认图层名称为`AEM-Assets`；但是，您可以在AEM Assets集成[&#128279;](../../aem-assets-integration/get-started/configure-aco.md)中的新用户引导期间指定自定义名称。
